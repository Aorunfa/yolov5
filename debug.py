...
train_path = '/highres_new/high_res/project/data_process/0_lora/yolov5/datasets/coco/val2017.txt'
imgsz = 640
batch_size = 16
WORLD_SIZE = 1
...
# import numpy as np
# cache_path = '/highres_new/high_res/project/data_process/0_lora/yolov5/datasets/coco/train2017.cache'
